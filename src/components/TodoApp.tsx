...
export function TodoApp({ user }: { user: AuthUser }) {
  const {tasks,projects,loading,error,retry,createProject,deleteProject,createTask,updateTask,setTaskCompleted,deleteTask,clearCompleted,resetWorkspace}=useWorkspace();
  ...
  return <div className={`app-shell ${collapsed?"is-collapsed":""}`}>
    ...
    <main>
      ...
      <div className="content">
        ...
        view==="projects"?<ProjectsView projects={projects} tasks={tasks} add={addProject} remove={removeProject} pending={projectPending}/>:
        <>
