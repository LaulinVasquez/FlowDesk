  ...
  return <div className={`app-shell ${collapsed?"is-collapsed":""}`}>
    ...
    <main>
      ...
      <div className="content">
        {view==="settings"?<SettingsView theme={theme} setTheme={setTheme} clearCompleted={()=>{setTasks(t=>t.filter(x=>!x.completed));notify("Completed tasks cleared")}} reset={()=>{setTasks([]);setProjects([]);notify("Workspace reset")}}/>:
